    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          children: [
            Positioned.fill(
              child: Image.asset("assets/images/admin_users_bg.jpg", fit: BoxFit.cover),
            ),
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          children: [
            Positioned.fill(
              child: Image.asset("assets/images/admin_status_bg.jpg", fit: BoxFit.cover),
            ),
            Container(color: Colors.black.withValues(alpha: 0.65)),
            RefreshIndicator(
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          children: [
            Positioned.fill(
              child: Image.asset("assets/images/admin_activity_bg.jpg", fit: BoxFit.cover),
            ),
