...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Widget _AdminSectionBackground({required String imagePath, required Widget child}) {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset(
  ...
  Widget _buildUsersSection() {
    return _AdminSectionBackground(
      imagePath: 'assets/images/admin_users_bg.jpg',
      child: StreamBuilder(
        stream: _usersStream,
  ...
  Widget _buildSystemStatusSection() {
    return _AdminSectionBackground(
      imagePath: 'assets/images/admin_status_bg.jpg',
      child: StreamBuilder(
  ...
  Widget _buildSystemActivitySection() {
    return _AdminSectionBackground(
      imagePath: 'assets/images/admin_activity_bg.jpg',
      child: StreamBuilder(
